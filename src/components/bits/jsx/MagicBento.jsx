...
const cardData = [
  {
    ...
    description: 'Websites that work perfectly on all devices and sizes.',
    label: 'Insights'
  },
  {
    color: '#060010',
    title: 'Modern User Interface',
    description: 'Modern and user-friendly designs that enhance the user experience.',
    label: 'Overview'
  },
  {
    color: '#060010',
    title: 'SEO Optimization',
    description: "SEO-optimized design to improve your site's visibility.",
    label: 'Teamwork'
  }
];
