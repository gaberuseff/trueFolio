            ...
            <AnimatePresence initial={false}>
              {activities.map((activity, index) => (
                <motion.div
                  ...
                  animate="visible"
                  exit="exit"
                  // Enables smooth layout transitions for adding/removing items
                  layout
                  className="flex items-start gap-3 p-4 hover:bg-muted/30 transition-colors duration-200">
                  {/* Icon */}
                  <div
                    className={cn("flex-shrink-0 p-1 rounded-full", // Default styling
...
const ExampleUsage = () => {
  ...
  return (
    <div
      className="p-8 bg-background border rounded-lg max-w-lg mx-auto shadow-md">
